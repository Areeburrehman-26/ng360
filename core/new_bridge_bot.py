...
async def full_flow(page: Page, context: BrowserContext, username: str, password: str, otp_sender: str, contact: dict, agent_id: str) -> dict:
    ...
    await page.locator("xpath=//*[@id='ctl00_MainContent_wgtMainMenuNewQuote_ddlState']").select_option("GA")
    ...
    prior_exp_raw = _contact_first(contact, "prior_expiration", "priorExpiration", "prior_policy_expiration")
    prior_exp_val = _date(str(prior_exp_raw)) if prior_exp_raw else "05/14/2026"
    ...
    await page.select_option("#MainContent_ucAutoQuestions_rpParentQuestions_ddlAnswer_0", "Individual")
    await asyncio.sleep(1)
    await page.select_option("#MainContent_ucAutoQuestions_rpParentQuestions_ddlAnswer_1", "True")
    await asyncio.sleep(1)
    await page.select_option("#MainContent_ucAutoQuestions_rpParentQuestions_ddlAnswer_2", "False")
    await asyncio.sleep(1)
    await page.select_option("#MainContent_ucAutoQuestions_rpParentQuestions_ddlAnswer_3", "False")
    await asyncio.sleep(1)
